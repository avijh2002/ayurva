...
const Footer = () => {
  return (
    <footer
      className="py-10 px-6 md:px-16 h-auto bg-[#283618]"
    >
      {/* Banner Section */}
          ...
          <div className="relative h-full overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="absolute inset-0 bg-opacity-30 flex justify-between items-end text-center p-6 m-4 mr-12">
              <div className="flex-col">
                <h2 className="text-white text-4xl md:text-5xl font-semibold text-left">
                  Take the First Step Toward a Pain-Free Life!
                </h2>
                <p className="text-gray-200 text-2xl mt-2 text-left">
      ...
      {/* Footer Content */}
      <div className="bg-[#283618] text-gray-300 h-[350px] ">
        <div className=" flex gap-10 justify-between h-full mx-5">
          {/* Navigation Links */}
          <div className="w-1/6">
            <h3 className="text-5xl font-semibold text-white">Explore</h3>
          ...
          <div className="flex-col  w-1/3 pr-60">
            <h3 className="text-5xl font-semibold text-white">Contact</h3>
            <p className="text-2xl mt-4 space-y-2">care@ayurva.digital</p>
            <p className="text-2xl mt-4 space-y-2">+91 8007968715</p>
            <div className="flex justify-between w-full  text-white text-3xl mt-20">
