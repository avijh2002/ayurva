...
const HeroSection = () => {
  return (
    <div
      className=" md:h-[645px] bg-[radial-gradient(64.38%_55.17%_at_10.47%_92.57%,_#F7D8B5_0%,_#FFFFFF_100%)] max-w-full mx-auto flex flex-col md:flex-row justify-between"
    >
      {/* Left Content */}
      ...
      <div className="hidden md:flex w-2/5 md:h-full bg-gray-500">
      ...
      {/* Right Image Grid */}
      <div className="flex w-full h-[160px] bg-gray-500 md:hidden">
