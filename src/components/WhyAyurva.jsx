...
const WhyAyurva = () => {
  return (
    <section className=" max-w-full mx-auto px-10 pt-[35px] md:pt-[78px] text-center">
      ...
      <div className=" px-[38px] py-[54px] h-[385px] w-full md:p-6 rounded-3xl shadow-sm bg-[#F3F7EE] flex flex-col justify-evenly items-center md:items-start  md:text-left">
        ...
        <div className="lg:col-span-2 px-[38px] py-[54px] h-[385px] w-full md:p-6 rounded-3xl shadow-sm bg-[#E7F8D3] flex flex-col justify-evenly items-center md:items-start  md:text-left">
        ...
        <div className="lg:col-span-2 px-[38px] py-[54px] h-[385px] w-full md:p-6 rounded-3xl shadow-sm  bg-[#D2E7BA] flex flex-col justify-evenly items-center md:items-start  md:text-left">
        ...
        <div className=" px-[38px] py-[54px] h-[385px] w-full md:p-6 rounded-3xl shadow-sm bg-[#BCD4B7] flex flex-col justify-evenly items-center md:items-start  md:text-left">
