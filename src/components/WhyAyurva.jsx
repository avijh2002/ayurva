...
const WhyAyurva = () => {
  return (
    <section className=" max-w-full mx-auto px-10 pt-[35px] md:pt-[78px] text-center">
      ...
      <div className=" px-[38px] py-[54px] h-[385px] w-full md:p-[45px] rounded-3xl shadow-sm bg-[#F3F7EE] flex flex-col justify-evenly items-center md:items-start  md:text-left">
        ...
        <div className="lg:col-span-2 px-[38px] py-[54px] h-[385px] w-full md:p-[45px] rounded-3xl shadow-sm bg-[#E7F8D3] flex flex-col justify-evenly items-center md:items-start  md:text-left">
          ...
          <p className=" text-sm md:text-lg text-center md:text-left text-[#757575] mt-1">Expertly designed yoga sessions tailored to your specific pain points and flexibility levels.</p>
        </div>

        <div className="lg:col-span-2 px-[38px] py-[54px] h-[385px] w-full md:p-[45px] rounded-3xl shadow-sm  bg-[#D2E7BA] flex flex-col justify-evenly items-center md:items-start  md:text-left">
          ...
          <p className=" text-sm md:text-lg text-center md:text-left text-[#757575] mt-1.5">Receive personalized treatment plans from experienced Ayurveda, Homeopathy, and Naturopathy specialists.</p>
        </div>

        <div className=" px-[38px] py-[54px] h-[385px] w-full md:p-[45px] rounded-3xl shadow-sm bg-[#BCD4B7] flex flex-col justify-evenly items-center md:items-start  md:text-left">
